...
<html lang="en">
  ...
  <a class="navbar-brand" href="{{route('home')}}">{{config('app.name','Laravel')}}>{{$classroom->section}}>{{ $classroom->name }}</a>
    ...
    <div class="dropdown text-end">
          ...
          <ul class="dropdown-menu text-small" style="">
           ...
           {{--<li><a class="navbar-brand" href="{{route('classrooms.join',$classroom->id)}}">Join Classroom</a></li> --}}
