...
class ClassroomMessagesController extends Controller
{
    ...
    {
         return $classroom->messages()->addSelect(['messages.id','messages.sender_id','messages.recipient_id','messages.recipient_type','messages.created_at as sent_at'])->with('sender:id,name')->latest()->paginate(30);
    }
